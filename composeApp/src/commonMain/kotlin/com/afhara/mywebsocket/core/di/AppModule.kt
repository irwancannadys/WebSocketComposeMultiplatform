...
import com.afhara.mywebsocket.feature.cryptolist.presentation.CryptoListViewModel
import com.afhara.mywebsocket.feature.dashboard.presentation.DashboardViewModel
...
val appModule = module {
    ...
    single { KrakenApi(get()) }

    // DataSource
    single { CryptoRemoteDataSource(get(), get(), get()) }
